import { SWITCH_LANGUAGE, LANG, CONTENTDATA, TOGGLE_COLLAPSED_NAV, WINDOW_WIDTH, ALLUSERS, ALLNOTIFICATION } from "../../constants/ActionTypes";
...
export function getAllUsers(content) {
  return {
    type: ALLUSERS,
    payload: content
  };
...
export function getAllNotification(content) {
  return {
